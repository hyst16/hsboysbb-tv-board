...
Data is scraped daily from the **NSAA boys basketball class pages** and saved into a JSON file that the front end reads.
...
- Scraper: `scraper/scrape_nsaa_boys_basketball.py`
  - Pulls from the NSAA boys basketball class pages (A, B, C1, C2, D1, D2), e.g.:
    - `https://nsaa-static.s3.amazonaws.com/calculate/showclassbbbA.html`
    - `https://nsaa-static.s3.amazonaws.com/calculate/showclassbbbB.html`
    - `https://nsaa-static.s3.amazonaws.com/calculate/showclassbbbC1.html`
    - `https://nsaa-static.s3.amazonaws.com/calculate/showclassbbbC2.html`
    - `https://nsaa-static.s3.amazonaws.com/calculate/showclassbbbD1.html`
    - `https://nsaa-static.s3.amazonaws.com/calculate/showclassbbbD2.html`
...
```text
https://your-username.github.io/hsboysbb-tv-board/
```
...
```text
https://your-username.github.io/hsboysbb-tv-board/?office=northbend-office&per=2&rotate=10
```
...
3. Run the scraper to generate `data/boys_basketball.json`:

   ```bash
   python scraper/scrape_nsaa_boys_basketball.py
   ```
